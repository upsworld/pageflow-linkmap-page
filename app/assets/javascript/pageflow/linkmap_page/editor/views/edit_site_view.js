pageflow.linkmapPage.EditSiteView = Backbone.Marionette.Layout.extend({
  template: 'pageflow/linkmap_page/editor/templates/edit_site',
  ...
  onRender: function() {
    ...
    configurationEditor.tab('general', function() {
      ...
      this.input('thumbnail', pageflow.FileInputView, {
        ...
        fileSelectionHandler: 'linkmapPage.site',
  ...
  goBack: function() {
    if (this.options.returnTo === 'page' && this.options.page) {
      ...
      pageflow.editor.navigate('/linkmap_page/sites' + query, {trigger: true});
    }
  }
});